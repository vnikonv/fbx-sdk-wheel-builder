...
with hints stub files (.pyi) enabled.

Each version is compiled for Windows (win_AMD64; with VS_2022), Linux (manylinux2014_x86_64),
and macOS (macosx_10_15_x86_64, macosx_11_0_ARM64, macosx_10_15_universal2). Since Python 3.7 is not officially supported on Apple Silicon, macosx_11_0_ARM64 and macosx_10_15_universal2 packages for this version will not be built.
